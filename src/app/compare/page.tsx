        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Match Data Graph Section */}
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-8">
                ...
                >
                    <option value="(auto_l1 + auto_l2 + auto_l3 + auto_l4 + teleop_l1 + teleop_l2 + teleop_l3 + teleop_l4)" >Total Coral</option>
                    <option value="(auto_l1 + auto_l2 + auto_l3 + auto_l4)" >Total Auto Coral</option>
                    <option value="auto_l1">Auto L1</option>
                    <option value="auto_l2">Auto L2</option>
                    <option value="auto_l3">Auto L3</option>
                    <option value="auto_l4">Auto L4</option>
                    <option value="(teleop_l1 + teleop_l2 + teleop_l3 + teleop_l4)" >Total Teleop Coral</option>
                    <option value="teleop_l1">Teleop L1</option>
                    <option value="teleop_l2">Teleop L2</option>
                    <option value="teleop_l3">Teleop L3</option>
                    <option value="teleop_l4">Teleop L4</option>
                    <option value="(auto_barge + teleop_barge)" >Total Barge</option>
                    <option value="auto_barge">Auto Barge</option>
                    <option value="teleop_barge">Teleop Barge</option>
